...
FILTER_SEEDS = {
    ...
    "mouse": [
        ...
        {"key": "buttons",  "label": "Numar Butoane", "values": ["3", "5", "6", "7", "8", "11", "13", "15", "17", "19"],          "order": 2},
    ],
    "keyboard": [
    ...
    "headset": [
        {"key": "wireless",   "label": "Conectivitate", "values": ["Wireless", "Fir"],                                                                          "order": 0},
        {"key": "microphone", "label": "Microfon",      "values": ["true", "false"],                                                                             "order": 1},
        {"key": "surround",   "label": "Sunet",         "values": ["stereo", "7.1 virtual", "DTS 7.1", "DTS Headphone:X", "DTS X 2.0", "Dolby 7.1", "Dolby Atmos", "THX Spatial"], "order": 2},
    ],
    "monitor": [
